...
@Component({
  ...
  standalone: true,
  imports: [InningBreakdown, InningDetail, LoadingState, PitchCountBreakdown, PitcherGameLogComponent, PitcherOverview, PitcherScoutingPrintView, PitcherSelector, PitcherValidationBanner, StickyPlayerHeader],
  host: { class: 'block' },
